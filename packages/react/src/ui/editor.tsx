...
const editorContainerVariants: any = cva(
...
export function EditorContainer({
  ...
  variant,
  ...props
}: EditorContainerProps): React.JSX.Element {
  return (
    <PlateContainer
      className={cn(
...
interface EditorProps extends PlateContentProps {
  ref?: React.RefObject<HTMLDivElement | null>
  disabled?: boolean
  focused?: boolean
  variant?: 'default' | 'demo' | 'ai' | 'aiChat' | 'comment' | 'fullWidth' | 'none' | 'select'
}

export function Editor({ ref, className, disabled, focused, variant, ...props }: EditorProps): React.JSX.Element {
  return (
    <PlateContent
      ref={ref}
      className={cn(
...
// 为了支持 isolatedDeclarations，我们需要明确声明 displayName 属性
(Editor as any).displayName = 'Editor'
